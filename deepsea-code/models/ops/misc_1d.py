...
class FrozenBatchNorm1d(torch.nn.Module):
    """
...
class ConvNormActivation(torch.nn.Sequential):
    def __init__(
        ...
        groups: int = 1,
        norm_layer: Optional[Callable[..., torch.nn.Module]] = None,# torch.nn.BatchNorm1d,
        ...
        if norm_layer is not None:
            layers.append(norm_layer(out_channels, track_running_stats=False))
