...
from models.ops.misc_1d import Conv1dNormActivation, SqueezeExcitation
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if norm_layer is None:
            norm_layer = None# nn.BatchNorm1d
        ...
        lastconv_output_channels = (
            ...
            last_channel if last_channel is not None else lastconv_input_channels
        )
        layers.append(
            Conv1dNormActivation(
