...
class Worker_Simulated(object):
    def __init__(self):#, acc_surrogate):
        #self.acc_surrogate = acc_surrogate
        self.acc = None

    def ObtainAcc(self, acc_surrogate, actions_index):
...
def get_acc(worker):
    ...
    train_data = torchvision.datasets.MNIST(
        root=worker.args.data, train=True, transform=train_transform, download=True
    )
